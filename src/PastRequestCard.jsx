...
const PastRequestCard = ({ walk, setPastRequest, pastRequest }) => {
    ...
    return (
        <div>
            <div className='rounded-lg bg-slate-100 bg-opacity-80 w-3/5 h-3/5 px-6 pt-6 pb-16 hover:bg-slate-800 hover:bg-opacity-80 hover:text-white shadow-lg mb-8'>
                ...
                <div>
                    <button className="p-2 mt-2 bg-blue-500 hover:bg-blue-400 text-slate-100 uppercase rounded-md float-right" onClick={() => { handleClick() }}>Walk Details</button>
                </div>
            </div>
        </div>
    )
